#!/usr/bin/env python3
"""
Script complet pour déployer les annonces fictives sur Render
...
from blizzgame.models import Post, Transaction, PostImage, PostVideo
from django.utils import timezone
from datetime import timedelta
import random
from decimal import Decimal

def deploy_fake_posts_complete():
    """Déploie complètement les annonces fictives sur Render"""
    print("DEPLOIEMENT COMPLET DES ANNONCES FICTIVES SUR RENDER")
    print("=" * 60)
    ...
    try:
        ...
        # Étape 1: Supprimer TOUTES les annonces existantes
        print("\n1. SUPPRESSION COMPLETE DES ANNONCES EXISTANTES...")
        ...
        if existing_posts > 0:
            ...
            print("TOUTES les annonces supprimees")
        
        # Vérification de la suppression
        remaining_posts = Post.objects.count()
        print(f"Annonces restantes apres suppression: {remaining_posts}")
        
        if remaining_posts > 0:
            print("ERREUR: Il reste des annonces a supprimer")
            return False
        
        # Étape 2: Créer les annonces fictives
        print("\n2. CREATION DES 200 ANNONCES FICTIVES...")
        ...
        captions = [
            "Compte en excellent etat, vente rapide",
            "Vente pour urgence, prix negociable",
            ...
            "Vente rapide, prix interessant",
            "Compte bien developpe",
            "Vente pour urgence financiere"
        ]
        ...
        if total_posts >= 200:
            print("SUCCESS: Deploiement des annonces fictives reussi!")
            print("Les anciens posts ont ete supprimes et remplaces par 200 posts fictifs")
            return True
        else:
