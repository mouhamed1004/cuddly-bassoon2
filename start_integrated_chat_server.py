#!/usr/bin/env python
"""
Script de démarrage pour tester le serveur avec le chat intégré
"""
import os
import sys
import subprocess
...
def show_test_instructions():
    ...
    print("\n2. 🧪 Tester la transaction en mode processing :")
    print("   - Aller sur http://localhost:8000/transaction/99147c44-4f3a-4354-a228-1172bd1b4f21/")
    print("   - Vérifier que le chat est ouvert et fonctionnel")
    print("   - Tester l'envoi de messages en temps réel")
    
    print("\n3. 🧪 Tester la transaction d'intégration :")
    print("   - Aller sur http://localhost:8000/transaction/c1807e0d-0bc9-47c7-8473-da5147f208de/")
    print("   - Vérifier que le chat est intégré dans la page de transaction")
    print("   - Tester l'envoi de messages via WebSocket")
